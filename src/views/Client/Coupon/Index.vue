            ...
            <div>
                <form @submit.prevent="submit()">
                    <div class="mb-4">
                        ...
                        <input v-model="form.code" id="code" type="text" class="w-full border-neutral-300 focus:border-neutral-300 focus:ring focus:ring-neutral-200 focus:ring-opacity-50 rounded-md shadow-sm  placeholder-neutral-300 bg-white p-2 text-lg border-[1px]" placeholder="入力してください"/>
