<template>
    <div class="flex min-h-screen text-neutral-700 text-base underline-offset-2 font-medium bg-white font-sans">
                ...
                <div class="flex justify-center xl:px-8 px-0 ">
                    <div class="md:w-[760px] w-full flex md:px-0 px-2 mx-auto justify-center md:gap-2 gap-1">
                        ...
                        <div class="flex-shrink-0 flex items-center">
                            <a :href="point_link" class="flex text-center text-sm text-white rounded-md bg-[#896858] overflow-hidden">
                        ...
                        <div class="relative flex-shrink-0 flex items-center">
                            ...
                            <a href="/login" v-else class="md:h-8 h-7 border-solid border-neutral-600 hover:bg-[#896858] border rounded-md md:px-5 px-2 text-sm text-black hover:text-white" as='button'>ログイン</a>
                        </div>
                    </div>
                </div>
...
export default {
    components: { Sidebar, Footer, TransitionRoot, TransitionChild, Dialog, DialogOverlay, XMarkIcon, ChevronLeftIcon, Bars3Icon, Menu, MenuButton, MenuItems, MenuItem,Logo},
    data() {
        return {
            sidebarOpened: false,
